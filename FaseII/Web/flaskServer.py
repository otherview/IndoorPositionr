...
class FlaskServer():
    ...
    def __init__(self ):
        ...
        @self.app.route('/_get_ap_positions')
        def get_ap_positions():
           
            return self.webAP.getKnownAPsJSON()
        ...
        def _get_possible_locations():
            ...
            return jsonify(self.webAP.getPossibility(position))
        
        @self.app.route('/_get_measured_path')
        def _get_measured_path():

            return jsonify(self.webAP.loadMeasuredPath())
