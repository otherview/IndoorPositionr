...
if __name__ == '__main__':
    reti = {}
    auth = {}
    auth[DOT11_AUTH_ALGO_80211_OPEN] = "Open"
    auth[DOT11_AUTH_ALGO_80211_SHARED_KEY] = "Shared-Key"
    auth[DOT11_AUTH_ALGO_WPA] = "WPA"
    auth[DOT11_AUTH_ALGO_WPA_PSK] =  "WPAPSK"
    auth[DOT11_AUTH_ALGO_WPA_NONE] = "WPA-None"
    auth[DOT11_AUTH_ALGO_RSNA] = "RSNA"
    auth[DOT11_AUTH_ALGO_RSNA_PSK] = "RSNAPSK"

    cifr = {}
    cifr[DOT11_CIPHER_ALGO_NONE] = "None"
    cifr[DOT11_CIPHER_ALGO_WEP40] = "WEP40"
    cifr[DOT11_CIPHER_ALGO_TKIP] = "TKIP"
    cifr[DOT11_CIPHER_ALGO_CCMP] = "CCMP"
    cifr[DOT11_CIPHER_ALGO_WEP104] = "WEP104"
    cifr[DOT11_CIPHER_ALGO_WEP] = "WEP"
        ...
        for iface in ifaces:
            ...
            try:
                ...
                for network in networks:
                    ...
                    net_auth = auth[network.dot11DefaultAuthAlgorithm]
                    net_cifr = cifr[network.dot11DefaultCipherAlgorithm]
                    net_essid = network.dot11Ssid.SSID[:network.dot11Ssid.SSIDLength]
                    net_security = network.SecurityEnabled
                    net_mac = network.NumberOfBssids
                    if_connected = "Not Connected"
                    if network.Flags == 3:
                        if_connected = "Currently Connected: Has Profile"

                    reti[net_essid] = [net_essid, net_signal, net_auth, net_cifr, net_security, if_connected]
                    print "\n\nnet essid: ", net_essid
                    print "net signal: ",net_signal
                    print "net auth: ", net_auth
                    print "net cifr: ", net_cifr
                    print "net security: ", net_security
                    print "connected: ", if_connected
                    print network.dot11BssType
                    print net_mac
