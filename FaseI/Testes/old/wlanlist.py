...
if __name__ == '__main__':
    ...
    plt.figure()
    #create some data
    x_series = [n+1 for n in range(0,10)]
    y_series_1 = [x for x in listings_dbm["eduroam"]]
